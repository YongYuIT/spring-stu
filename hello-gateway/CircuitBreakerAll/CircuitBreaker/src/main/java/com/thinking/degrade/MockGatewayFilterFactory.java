...
public class MockGatewayFilterFactory extends AbstractGatewayFilterFactory {
    ...
    GatewayFilter mockFilter = (exchange, chain) -> {
        ...
        System.out.println("111 MockGatewayFilterFactory header-->" + JSON.toJSONString(request.getHeaders()));
        System.out.println("111 MockGatewayFilterFactory url-->" + uri);
        System.out.println("111 MockGatewayFilterFactory body-->" + JSON.toJSONString(exchange.getAttribute("cachedRequestBodyObject")));
